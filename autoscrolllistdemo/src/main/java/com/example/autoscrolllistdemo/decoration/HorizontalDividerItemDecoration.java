...
public class HorizontalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    public HorizontalDividerItemDecoration(HorizontalDividerItemDecoration.Builder builder) {
        super(builder);
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<HorizontalDividerItemDecoration.Builder> {

        private HorizontalDividerItemDecoration.MarginProvider mMarginProvider = new HorizontalDividerItemDecoration.MarginProvider() {
            @Override
        ...
        public HorizontalDividerItemDecoration.Builder margin(final int leftMargin, final int rightMargin) {
            return marginProvider(new HorizontalDividerItemDecoration.MarginProvider() {
                @Override
                public int dividerLeftMargin(int position, RecyclerView parent) {
                    return leftMargin;
                }
        ...
        public HorizontalDividerItemDecoration.Builder margin(int horizontalMargin) {
            return margin(horizontalMargin, horizontalMargin);
        }

        public HorizontalDividerItemDecoration.Builder marginResId(@DimenRes int leftMarginId, @DimenRes int rightMarginId) {
            return margin(mResources.getDimensionPixelSize(leftMarginId),
                    mResources.getDimensionPixelSize(rightMarginId));
        }

        public HorizontalDividerItemDecoration.Builder marginResId(@DimenRes int horizontalMarginId) {
            return marginResId(horizontalMarginId, horizontalMarginId);
        }

        public HorizontalDividerItemDecoration.Builder marginProvider(HorizontalDividerItemDecoration.MarginProvider provider) {
