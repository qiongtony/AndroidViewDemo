...
public class VerticalDividerItemDecoration extends FlexibleDividerDecoration {
    ...
    public VerticalDividerItemDecoration(VerticalDividerItemDecoration.Builder builder) {
        super(builder);
    ...
    public static class Builder extends FlexibleDividerDecoration.Builder<VerticalDividerItemDecoration.Builder> {

        private VerticalDividerItemDecoration.MarginProvider mMarginProvider = new VerticalDividerItemDecoration.MarginProvider() {
            @Override
        ...
        public VerticalDividerItemDecoration.Builder margin(final int topMargin, final int bottomMargin) {
            return marginProvider(new VerticalDividerItemDecoration.MarginProvider() {
                @Override
                public int dividerTopMargin(int position, RecyclerView parent) {
                    return topMargin;
                }
        ...
        public VerticalDividerItemDecoration.Builder margin(int verticalMargin) {
            return margin(verticalMargin, verticalMargin);
        }

        public VerticalDividerItemDecoration.Builder marginResId(@DimenRes int topMarginId, @DimenRes int bottomMarginId) {
            return margin(mResources.getDimensionPixelSize(topMarginId),
                    mResources.getDimensionPixelSize(bottomMarginId));
        }

        public VerticalDividerItemDecoration.Builder marginResId(@DimenRes int verticalMarginId) {
            return marginResId(verticalMarginId, verticalMarginId);
        }

        public VerticalDividerItemDecoration.Builder marginProvider(VerticalDividerItemDecoration.MarginProvider provider) {
