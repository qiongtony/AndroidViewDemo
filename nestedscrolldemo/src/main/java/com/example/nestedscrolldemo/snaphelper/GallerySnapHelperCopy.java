...
public class GallerySnapHelperCopy extends SnapHelper {
    ...
    private int distanceToStart(View targetView, OrientationHelper helper) {
        Log.i("WWS", "distanceToStart decoratedStart = " + helper.getDecoratedStart(targetView) + " startAfterPadding = " + helper.getStartAfterPadding());
